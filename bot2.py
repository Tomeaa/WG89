...
token = "7373076061:AAGMuEswaXjKaj-n7KWxtPK5kOqPJgxRLIM" #التوكن هنا 
	...
	try:
		with open("combo.txt", 'r') as file:
			...
			for cc in lino:
				...
				cm2 = types.InlineKeyboardButton(f"• 𝑪𝑯𝑨𝑹𝑮𝑬 ✅: [ {ch} ] •", callback_data='x')
				...
				bot.edit_message_text(chat_id=message.chat.id, message_id=ko, text='''انتظرني افحص و لا تدوخني
